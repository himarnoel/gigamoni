...
const Services = () => {
  return (
    <div className="bg-[#87ACA3]  w-full mt-20  pb-20  px-2 sm:px-10  md:px-8  lg:px-10  xl:px-[10rem]  py-[1rem]">
      ...
      <div className="grid md:grid-cols-2 mt-10">
        ...
        <div className="w-full  card  h-[20rem]  xs:h-[18rem] rounded-[14.572px] md:rounded-[23.8886px] relative mb-10">
          <img
            src={bg}
            alt=""
            className="object-cover w-full h-[20rem]  xs:h-[18rem] rounded-[16px] opacity-[0.1] md:rounded-[23.8886px] mix-blend-overlay "
          />
          <p className=" text-lg md:text-sm  lg:text-lg md:ml-5 left-0 right-0 font-semibold absolute top-[1.3rem] xs:top-[1.2rem] text-center">
            Secure Funding for Large Purchase Orders
          </p>
          <p className="text-xs font-normal mx-5 font-[#262626] absolute top-[5rem] xss:top-[6rem] xs:top-[5.5rem] md:top-[4.6rem] left-0 right-0 leading-[1.3rem] xss:leading-[1.6rem]  xs:leading-[1.5rem]   md:leading-[1.5rem] lg:leading-[2rem] ">
