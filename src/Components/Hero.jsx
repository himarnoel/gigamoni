  ...
  return (
    <div>
      ...
      <div className="">
        {/* global text */}
        <div
          className="mx-2 md:mx-1 text-white z-40 text-2xl left-0 right-0  md:right-[16rem]  lg:right-[27rem] xl:right-[50rem]   md:text-left sm:text-4xl   leading-loose absolute top-24  lg:top-[16rem] md:top-[10rem] md:left-8  lg:left-10 xl:left-24
  "
        >
          ...
          <ol className="md:text-sm ml-4 md:mt-6 lg:mt-3 text-sm  font-light list-disc leading-[2.3]">
        ...
        <div>
            <img
              src={card}
              alt=""
              className="absolute object-contain hidden md:block   w-[16rem]  xl:w-[23rem]  md:w-[15rem] lg:w-[20rem] lg:right-10 md:right-8 md:top-64    xl:right-24 z-[200]  lg:top-[19rem] xl:top-[18rem] "
            />
        </div>
      </div>
    </div>
