    ...
    <div>
      <div className="flex flex-col h-screen  font-poppins justify-between">
        ...
        <div className="bg flex-auto lg:flex justify-around items-center flex-col   ">
          ...
          <div className="flex flex-col items-center w-full  h-[25rem] xss:h-[22rem] xs:h-[25rem] md:h-[29rem] lg:h-[28rem] xl:h-[32rem] px-2 xss:px-4 xs:px-6 sm:px-[6rem]  md:px-[8rem] lg:px-[18rem] xl:px-[23.4rem]  mx-auto mt-2 xss:mt-2 xs:mt-4  md:mt-6 lg:mt-0">
            <div className="mx-auto text-[#262626] text-center flex flex-col  shade  items-center bg-[#F8F8FF]  px-2 xs:px-4 sm:px-6  xl:px-[4rem]  rounded-[8px] md:rounded-[11.8392px] w-full h-full  shadow-[0_35px_60px_-15px_rgba(25,0,0,0.3)]">
              ...
              <p className="text-xs  mt-6  xs:mt-3 md:mt-3 md:text-sm lg:text-xs xl:mt-3">
                If you can’t find the email kindly check your spam folder
              </p>
              <p className="text-xs mt-[4rem] md:mt-20 xss:mt-10 xs:mt-14 md:text-sm xl:text-sm xl:mt-20">
                Didn't receive email?
              </p>

              <button className="px-12 py-[0.78rem] sm:py-3 lg:py-3  xl:px-12 bg-[#009186] text-white rounded-[8px] text-sm mt-2">
                Resend Mail
              </button>
            </div>
