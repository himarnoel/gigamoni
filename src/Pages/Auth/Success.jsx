    ...
    <div>
      <div className="flex flex-col h-screen  font-poppins justify-between ">
        ...
        <div className="bg flex-auto sm:flex flex-col justify-center items-center   ">
          <div className="w-full px-2 xss:px-4 xs:px-6 xsm:px-[5rem] sm:px-0 sm:w-fit  mx-auto mt-[8rem] mxl:mt-[-20rem] ">
            ...
            <div className="mx-auto bg-[#F8F8FF] w-full h-[20rem] items-center  mt-8  sm:w-[35rem] sm:h-[20rem] mxl:mt-[4rem] md:w-[40rem] md:h-[25rem] lg:h-[19rem] lg:w-[30rem] mxl:w-[40rem] mxl:h-[25rem] md:mt-[5rem] lg:mt-[3rem]  rounded-[11.8392px] shade px-4 py-2 sm:px-10 sm:py-8 md:px-20 md:py-14 lg:px-10 lg:py-10 flex flex-col justify-around  xl:mt-5">
              {" "}
              ...
              Login with the new password to updated your account
              </p>
              <button
