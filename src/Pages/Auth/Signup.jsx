...
const Signup = () => {
  return (
    <div className="flex flex-col justify-between">
      <NavBar class="" />
      <div className="grid md:grid-cols-2  justify-between place-content-between justify-items-between h-screen">
        <div className="w-full flex flex-col justify-around   pt-[3.3rem]">
          <div>
            {" "}
            <h2 className="text-center text-[1.5rem] font-semibold text-[#262626] ">
              Create Account
            </h2>
            <h1 className="text-xl font-bold  lg:mx-10 xl:mx-[5rem] 2xl:mx-[10rem]">
              Hello,
            </h1>
          </div>
          <div className="lg:h-[24rem] xl:h-[25rem]  flex flex-col justify-between   lg:mx-10 xl:mx-[8rem] 2xl:mx-[10rem]">
            ...
            <button className="px-3 py-2 self-end  bg-[#009186] text-[#F8F8FF] rounded-[8px] font-semibold">
              Create Account
            </button>
          </div>
          ...
          <div>
            {" "}
            <span className="flex items-center mt-2  lg:mx-10 xl:mx-[8rem] 2xl:mx-[10rem]">
              {" "}
              <p className=" text-[#262626] mr-2">Already have an account?</p>
              <span className="text-[#009186]">Login</span>
            </span>
            <span className=" flex items-center justify-center py-3 border-2  border-[#009186] border-solid rounded-[8px] mt-2  lg:mx-10 xl:mx-[8rem] 2xl:mx-[10rem]">
              {" "}
