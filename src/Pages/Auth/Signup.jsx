        ...
        <div className="sjs w-full lg:px-10 xl:px-[8rem] 2xl:px-[10rem] pt-[5.4rem]">
          ...
          <div class="relative z-0">
            <input
              type="text"
              id="small_standard"
              class="block font-poppins mt-10 w-full pl-5 pb-1 pt-3 py-2 text-sm text-gray-900 bg-transparent border-0 border-b-[1.5px] border-[#262626] appearance-none dark:text-white  focus:outline-none focus:ring-0 focus:border-[#009186] peer"
              placeholder=" "
            />
            <label
              for="small_standard"
