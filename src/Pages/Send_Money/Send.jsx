...
const Send = () => {
  ...
  return (
    <div>
      ...
      <div
        className="bg-[#006159] w-full mt-[5rem]
      "
      >
        <div className="bg-[#2B7C85]">
          <p className="text-[#F8F8FF] text-2xl text-center font-semibold pt-1">
            Send Money
          </p>
          <span className=" absolute  text-white text-[1.8rem] text-center top-[10rem] font-semibold w-[25rem]  right-0">
            A faster way to make international Payments
          </span>
          <img
            src={img1}
            alt=""
            className="mt-3 object-contain w-[20rem] mx-auto"
          />
          <img
            src={img2}
            alt=""
        ...
        <div className="w-full bg-[#006159] px-8">
          <div className="bg-white"> safsdfas</div>
        </div>
      </div>
    </div>
  );
